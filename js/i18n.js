(function () {
  ...
  var T = {
    en: {
      ...
      titleLogo: 'Back to home — Lenilson Pinheiro Valério',
      titleLang: 'Choose site language: English (US), Portuguese (BR), or Spanish',
      titleNavHome: 'Introduction — headline and positioning',
      titleNavAbout: 'Profile — summary and impact metrics',
      titleNavExperience: 'Experience — aligned with résumé and LinkedIn',
      titleNavTech: 'Stack & tools — platforms I work with',
      titleNavProjects: 'Program highlights — outcomes by domain',
      titleNavFaq: 'Recruiter FAQ — roles, certifications, how to reach me',
      titleNavContact: 'Contact — email, phone, LinkedIn, secure form',
      titleHeroPrimary: 'View selected programs and results',
      titleHeroSecondary: 'Get in touch — contact options below',
      titleStat1: '~25 years in IT and delivery leadership (per résumé)',
      titleStat2: '+15% fraud-model precision uplift at Citibank (per résumé)',
      titleStat3: 'Core certifications: PMP (PMI) and PSM I (Scrum.org)',
      titleStat4: 'Years leading Citibank programs via Qintess (per résumé)',
      titleEmail: 'Email lenilsonpinheiro@gmail.com',
      titlePhone: 'Call or message +55 85 99733-1000',
      titleLinkedIn: 'LinkedIn — roles, timeline, recommendations',
      titleGitHub: 'GitHub — code samples and public activity',
      titleSubmit: 'Send message securely over HTTPS',
      titleTechCard: 'Capability aligned with my résumé — depth on LinkedIn or CV PDF',
      titleProjectCard: 'Program highlight — verify scope and dates on LinkedIn or résumé PDF',
      titleFormSection: 'Contact form — short hints under each field',
      ...
      privacyUpdatedLine: 'Last updated: <time datetime="2026-05-10">10 May 2026</time>',
      ...
      termsUpdatedLine: 'Last updated: <time datetime="2026-05-10">10 May 2026</time>',
    ...
    pt: {
      ...
      titleLogo: 'Voltar ao início — Lenilson Pinheiro Valério',
      titleLang: 'Escolher idioma: inglês (EUA), português (BR) ou espanhol',
      titleNavHome: 'Introdução — posicionamento e headline',
      titleNavAbout: 'Perfil — resumo e indicadores de impacto',
      titleNavExperience: 'Experiência — alinhada ao CV e ao LinkedIn',
      titleNavTech: 'Stack e ferramentas — ecossistemas em que atuo',
      titleNavProjects: 'Destaques de programa — resultados por área',
      titleNavFaq: 'FAQ para recrutadores — papéis, certificações, contacto',
      titleNavContact: 'Contacto — e-mail, telefone, LinkedIn, formulário seguro',
      titleHeroPrimary: 'Ver programas e resultados em destaque',
      titleHeroSecondary: 'Falar comigo — opções de contacto abaixo',
      titleStat1: '~25 anos em TI e liderança de entregas (conforme currículo)',
      titleStat2: '+15% de ganho de precisão no modelo antifraude no Citibank (CV)',
      titleStat3: 'Certificações centrais: PMP (PMI) e PSM I (Scrum.org)',
      titleStat4: 'Anos a liderar programas no Citibank via Qintess (CV)',
      titleEmail: 'Enviar e-mail para lenilsonpinheiro@gmail.com',
      titlePhone: 'Ligar ou mensagem +55 85 99733-1000',
      titleLinkedIn: 'LinkedIn — cargos, cronologia e recomendações',
      titleGitHub: 'GitHub — código e atividade pública',
      titleSubmit: 'Enviar mensagem com segurança (HTTPS)',
      titleTechCard: 'Competência alinhada ao currículo — detalhes no LinkedIn ou CV PDF',
      titleProjectCard: 'Destaque de programa — confira âmbito e datas no LinkedIn ou CV PDF',
      titleFormSection: 'Formulário de contacto — dicas curtas sob cada campo',
      ...
      privacyUpdatedLine: 'Última atualização: <time datetime="2026-05-10">10 de maio de 2026</time>',
      ...
      termsUpdatedLine: 'Última atualização: <time datetime="2026-05-10">10 de maio de 2026</time>',
    ...
    es: {
      ...
      titleLogo: 'Volver al inicio — Lenilson Pinheiro Valério',
      titleLang: 'Elegir idioma: inglés (EE.UU.), portugués (BR) o español',
      titleNavHome: 'Introducción — posicionamiento y titular',
      titleNavAbout: 'Perfil — resumen e indicadores de impacto',
      titleNavExperience: 'Experiencia — alineada al CV y a LinkedIn',
      titleNavTech: 'Stack y herramientas — ecosistemas en los que trabajo',
      titleNavProjects: 'Hitos de programa — resultados por ámbito',
      titleNavFaq: 'FAQ para reclutadores — roles, certificaciones, contacto',
      titleNavContact: 'Contacto — correo, teléfono, LinkedIn, formulario seguro',
      titleHeroPrimary: 'Ver programas y resultados destacados',
      titleHeroSecondary: 'Hablar conmigo — opciones de contacto abajo',
      titleStat1: '~25 años en TI y liderazgo de entregas (según CV)',
      titleStat2: '+15% de mejora en precisión antifraude en Citibank (CV)',
      titleStat3: 'Certificaciones clave: PMP (PMI) y PSM I (Scrum.org)',
      titleStat4: 'Años liderando programas en Citibank vía Qintess (CV)',
      titleEmail: 'Enviar correo a lenilsonpinheiro@gmail.com',
      titlePhone: 'Llamar o mensaje +55 85 99733-1000',
      titleLinkedIn: 'LinkedIn — cargos, cronología y recomendaciones',
      titleGitHub: 'GitHub — código y actividad pública',
      titleSubmit: 'Enviar mensaje de forma segura (HTTPS)',
      titleTechCard: 'Competencia alineada al CV — detalle en LinkedIn o CV PDF',
      titleProjectCard: 'Hito de programa — verifique alcance y fechas en LinkedIn o CV PDF',
      titleFormSection: 'Formulario de contacto — ayuda breve bajo cada campo',
      ...
      privacyUpdatedLine: 'Última actualización: <time datetime="2026-05-10">10 de mayo de 2026</time>',
      ...
      termsUpdatedLine: 'Última actualización: <time datetime="2026-05-10">10 de mayo de 2026</time>',
